...
# ─────────────────────────────────────────────────────────────────────────────
# MAPEAMENTO CLIQ E BUSCA DE VOLUMES
# ─────────────────────────────────────────────────────────────────────────────
COLUNAS_CLIQ = {
...
# 5. CARREGAMENTO DOS DADOS (Omitido para brevidade, mas igual ao anterior)
...
# [Carregamento de dicionários de apoio mantido conforme versões anteriores...]
...
if st.session_state['df_bruto'] is not None:
    try:
        ...
        if not df_filtrada.empty:
            ...
            # --- MONTAGEM DAS COLUNAS (ORDEM ORIGINAL) ---
            ...
            # Resolvendo o Código do Contrato Cliq
            ...
            # Volume BOOK (Soma do que está no Book para aquele contrato)
            ...
            # --- NOVA COLUNA: Volume CliqCCEE (Busca direta na MWmedio da CCEE) ---
            ...
            # --- ORDEM FINAL DAS COLUNAS (RESTAURADA) ---
            ordem = [col_boleta, 'Operacao', 'Tipo Energia', 'Parte', 'Contraparte', 'CP/LP', 
                    ...
                    'Volume BOOK', 'Volume CliqCCEE', # <--- Nova coluna aqui
